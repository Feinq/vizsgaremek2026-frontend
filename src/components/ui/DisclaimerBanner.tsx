	...
	return (
		...
		>
			<div className="max-w-4xl mx-auto">
				<div className="bg-white border border-slate-200 rounded-xl sm:rounded-2xl shadow-xl shadow-slate-200/50 p-4 sm:p-6">
					{/* Close button - absolute positioned on mobile */}
					<button
						onClick={() => setIsVisible(false)}
						className="absolute top-6 right-6 sm:hidden p-3 text-slate-400 cursor-pointer hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-colors"
						aria-label="Bezárás"
					>
					...
					<div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
						...
						<div className="hidden sm:flex w-10 h-10 bg-blue-50 rounded-xl items-center justify-center shrink-0">
						...
						<div className="flex-1 min-w-0 pr-6 sm:pr-0">
							<div className="flex items-center gap-2 mb-1">
								<Info className="w-4 h-4 text-blue-600 sm:hidden" aria-hidden="true" />
						...
						<div className="flex items-center gap-2 shrink-0">
							...
							<button
								onClick={() => setIsVisible(false)}
								className="hidden sm:flex p-2 text-slate-400 cursor-pointer hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-colors"
								aria-label="Bezárás"
							>
